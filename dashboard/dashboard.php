        ...
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><a href=" " target="_blank">LinkedIn</a></li>
...
<button class="sunset-orange-button gradient-button"><a href="<?php echo $t2=$_POST['t2']; ?>">Task 2</a></button>
<button class="spring-green-button gradient-button"><a href="<?php echo $t3=$_POST['t3']; ?>">Task 3</a></button>
<button class="royal-purple-button gradient-button"><a href="<?php echo $t4=$_POST['t4']; ?>">Task 4</a></button>
<button class="ruby-red-button gradient-button"><a href="<?php echo $t5=$_POST['t5']; ?>">Task 5</a></button>
<button class="goldenrod-yellow-button gradient-button"><a href="<?php echo $t6=$_POST['t6']; ?>">Minor Project Module</a></button><br>

<button class="spring-green-button gradient-button"><a href="<?php echo $t7=$_POST['t7']; ?>">Database  Module</a></button>
                        </div>
                    </div>
                    <div class="dashboard-item">
